      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[60] bg-white rounded-t-[28px] pb-safe shadow-2xl max-h-[90dvh] overflow-y-auto"
          >
            {/* Handle */}
        ...
        {showSignOutConfirm && (
          <>
            ...
            <motion.div
              ...
              className="fixed z-[60] inset-x-5 bottom-20 sm:inset-auto sm:left-1/2 sm:-translate-x-1/2 sm:bottom-auto sm:top-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-sm"
            >
